...
if __name__ == "__main__":
    ...
    parser.add_argument('--weights', default='models/nofixed_nochange_best', required=False, help='Path to weights')
    parser.add_argument('--config', default='config/充电桩位置随机_map不变.json', required=False, help='Config file for agent '
                                                                                             'shaping')
