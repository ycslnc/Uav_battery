...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', default='config/88_dh_充电时battery_map不变化.json', help='Path to config file')
    parser.add_argument('--id', default='dh_battery_充电时battery_map不变化', help='If set overrides the logfile name and the save name')
