...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', default='./config/88_dh.json', help='Path to config file')
    parser.add_argument('--id', default='train_dh_new_battery5', help='If set overrides the logfile name and the save '
                                                                      'name')
