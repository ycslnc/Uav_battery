...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', default='config/充电桩位置随机_map不变.json', help='Path to config file')
    parser.add_argument('--id', default='充电桩位置随机_map不变.json', help='If set overrides the logfile name and the save name')
